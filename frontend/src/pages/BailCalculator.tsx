  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col gap-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Bail Eligibility Calculator</h1>
          <p className="text-muted-foreground">Calculate bail eligibility based on legal provisions</p>
        </div>
          ...
          <TabsContent value="crpc">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Calculate bail eligibility based on Code of Criminal Procedure provisions
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={(value) => handleChange("section", value)}>
                      <SelectTrigger id="ipc-section">
                        <SelectValue placeholder="Select IPC section" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="section-302">Section 302 - Murder</SelectItem>
                        <SelectItem value="section-376">Section 376 - Rape</SelectItem>
                        <SelectItem value="section-420">Section 420 - Cheating</SelectItem>
                        <SelectItem value="section-307">Section 307 - Attempt to Murder</SelectItem>
                        <SelectItem value="section-326">Section 326 - Voluntarily causing grievous hurt</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="max-sentence">Maximum Sentence (Years)</Label>
                    <Input
                      id="max-sentence"
                      type="number"
                      placeholder="Enter maximum sentence"
                      value={formData.maxSentence}
                      onChange={(e) => handleChange("maxSentence", e.target.value)}
                    />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="time-served">Time Already Served (Years)</Label>
                    <Input
                      id="time-served"
                      type="number"
                      placeholder="Enter time served"
                      value={formData.timeServed}
                      onChange={(e) => handleChange("timeServed", e.target.value)}
                    />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="pending-cases">Pending Cases</Label>
                    <Select onValueChange={(value) => handleChange("pendingCases", value)}>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="previous-convictions">Previous Convictions</Label>
                    <Select onValueChange={(value) => handleChange("previousConvictions", value)}>
                ...
                <div className="bg-muted p-4 rounded-md">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm font-medium">CrPC Bail Eligibility Criteria</p>
                      <p className="text-sm text-muted-foreground">
                        Under Section 436A of CrPC, an undertrial prisoner is eligible for bail after serving half of
                        the maximum sentence, except for offenses punishable with death or life imprisonment, or if
          ...
          <TabsContent value="bnss">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Calculate bail eligibility based on Bhartiya Nyaya Sanhita provisions</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="section-103">Section 103 - Murder</SelectItem>
                        <SelectItem value="section-65">Section 65 - Sexual Assault</SelectItem>
                        <SelectItem value="section-318">Section 318 - Cheating</SelectItem>
                        <SelectItem value="section-109">Section 109 - Attempt to Murder</SelectItem>
                        <SelectItem value="section-115">Section 115 - Grievous Hurt</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="max-sentence-bnss">Maximum Sentence (Years)</Label>
                    <Input id="max-sentence-bnss" type="number" placeholder="Enter maximum sentence" />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="time-served-bnss">Time Already Served (Years)</Label>
                    <Input id="time-served-bnss" type="number" placeholder="Enter time served" />
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="previous-convictions-bnss">Previous Convictions</Label>
                    <Select>
                ...
                <div className="bg-muted p-4 rounded-md">
                  <div className="flex items-start gap-2">
                    <Info className="h-5 w-5 text-primary mt-0.5" />
                    <div>
                      <p className="text-sm font-medium">BNSS Bail Eligibility Criteria</p>
                      <p className="text-sm text-muted-foreground">
                        Under BNSS provisions, an undertrial prisoner is eligible for bail after serving one-third of
                        the maximum sentence, except for offenses punishable with life imprisonment, or if there are
                        multiple pending charges or cases.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <CardContent className="space-y-4">
              {calculationResult.eligible ? (
                <Alert className="border-green-500 bg-green-50 dark:bg-green-950 dark:border-green-800">
                  ...
                  <div className="ml-3">
                    <h5 className="text-green-700 dark:text-green-300 font-medium">Eligible for Bail</h5>
                    <p className="text-green-600 dark:text-green-400 text-sm">{calculationResult.reason}</p>
                  </div>
                </Alert>
              ) : (
                <Alert className="border-red-500 bg-red-50 dark:bg-red-950 dark:border-red-800">
                  ...
                  <div className="ml-3">
                    <h5 className="text-red-700 dark:text-red-300 font-medium">Not Eligible for Bail</h5>
                    <p className="text-red-600 dark:text-red-400 text-sm">{calculationResult.reason}</p>
                  </div>
                </Alert>
              )}
              ...
              <div className="p-4 border rounded-md">
                ...
                <p className="text-muted-foreground">{calculationResult.recommendation}</p>
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="flex justify-between mt-1">
                  ...
                  <span className="text-xs font-medium">{calculationResult.eligibilityScore}%</span>
